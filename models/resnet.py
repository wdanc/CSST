...
from models.nest import Upsample, PCTransformerLevel, _init_nest_weights, partial, trunc_normal_, named_apply
...
class CAT_res(nn.Module):
    def __init__(self, block, layers, zero_init_residual=False, groups=1, width_per_group=64,
        ...
        for i in range(self.num_levels):
            ...
            dim = embed_dims[i]
            diff_levels.append(PCTransformerLevel(
